      ...
      >
        <div className="md:max-w-lg">
          ...
          >
            ...
            {flags.contact && <a href="#contact" className="bg-primary-400 text-white secondary-button truncate transition hover:text-primary-400 hover:bg-white">Contact Us</a>}
          </div>
        </div>
